...
namespace math
{
     ...
     inline typename tools::promote_args<ArgumentType,int>::type lambert_w(const ArgumentType& z)
     {
     ...
     inline typename tools::promote_args<ArgumentType,IndexType>::type lambert_w(const ArgumentType& z, const IndexType& k)
     {
     ...
     inline typename tools::promote_args<ArgumentType,IndexType>::type lambert_w(const ArgumentType& z, const IndexType& k, const Policy& pol)
     {
          BOOST_FPU_EXCEPTION_GUARD

          typedef typename tools::promote_args<ArgumentType,IndexType>::type result_type;
     ...
     inline std::complex<ArgumentType> lambert_w(const std::complex<ArgumentType>& z, const IndexType& k, const Policy& pol)
     {
          ...
          return policies::checked_narrowing_cast<result_type, forwarding_policy>(
               lambw::_with_complex_range_checks<std::complex<result_type>,result_type,Policy>(
